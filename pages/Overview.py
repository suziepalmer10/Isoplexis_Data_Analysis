...
layout = html.Div(
    [
        ...
        html.P([
            ...
            html.A("Link to Isoplexis Website",
                    href='https://isoplexis.com/support/analyze-your-data/', target="_blank")]),
        html.H4('Mouse Single-Cell Adaptive Immune - 28 Cytokines',
                style={"text-decoration": "none", 'textAlign': 'center'}),
        dbc.Row([
            dbc.Col(),
            dbc.Col(
                html.Div(mouse_ad_table), width = "8"),
            dbc.Col()]),
        dbc.Row(
        ...
        dbc.Row([
            dbc.Col(),
            dbc.Col(
                html.Div(human_ad_table), width = "8"),
            dbc.Col()]),
        dbc.Row(
            [dbc.Col(html.Div(html.Hr()), width={"size": 2, "offset": 5})]),
        ...
        dbc.Row([
            dbc.Col(),
            dbc.Col(
                html.Div(human_inflam_table), width = "8"),
            dbc.Col()]),
        dbc.Row(
            [dbc.Col(html.Div(html.Hr()), width={"size": 2, "offset": 5})]),
        ...
        dbc.Row([
            dbc.Col(),
            dbc.Col(
                html.Div(human_inn_table), width = "8"),
            dbc.Col()]),
        ...
        html.H2(dcc.Markdown('''
             **Contact Information**
            '''),  style={"text-decoration": "none", 'textAlign': 'center'}),
        html.P('Questions and comments should be directed towards:',
               style=centerStyle),
        html.P(dcc.Markdown('''
        ...
        html.P(html.A("Suzette Palmer's Github",
