                ...
                dbc.Row(
                    [
                        dbc.Col(
                            html.Div(
                                [
                                    dcc.Graph(id="polyfunctional_bar"),
...
@callback(
    Output("polyfunctional_bar", "figure"),
...
def polyfunctional_bar_(n, cyto_list, df):
    try:
        if n is None:
            ...
            df = pd.DataFrame(
                list(zip(df_condition_labels, df_count_labels, df_count_list)),
                columns=[
                    "Treatment Conditions",
                    "Polyfunctionality Percentages",
            ...
            fig = px.bar(
                ...
                y="Percent Polyfunctional Cytokines Secreting",
                color="Polyfunctionality Percentages",
