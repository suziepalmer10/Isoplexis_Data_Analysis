...
layout = html.Div(
    [
        ...
        html.P(
            ...
            html.A("CSV example", href="assets/WT_ABX_MLN_T_Cell_CD4+_CD8+_raw_data.csv"),
            " or ",
            ...
            [
                ...
                html.Div([
                    ...
                    html.P([
                        ...
                        style={'textAlign': 'left'}),
                    html.Div(upload_data_summary, id = 'upload-data-summary', style = {'display':"none"},className = "border border-danger")
                    ], className = "shadow p-3 mb-5 bg-white rounded"),
...
def col_row_check(n, cyto_list, df):
    if n is None:
        ...
        check_cyto_num = html.Div([
            ...
            html.P('Please ensure that the number of cytokines and the number of cells displayed below are correct before proceeding.')])
